                        ...
                        if (status === "1") {
                            ...
                            $('.toggle-button').on('click', function (event) {
                                if (!$(this).hasClass('disabled')) {
                                    ...
                                    // Check if the clicked time is already booked
                                    if ($(this).hasClass('active')) {
                                        // Remove 'active' class and reset start time
                                        ...
                                        if (startTime === null) {
                                            ...
                                            // Check if any time in the selected range is already booked
                                            ...
                                            if (!isRangeBooked) {
                                                ...
                                                // Reset start time if the range is already booked
                                                startTime = null;
                                            }
                                        }
                                    }
